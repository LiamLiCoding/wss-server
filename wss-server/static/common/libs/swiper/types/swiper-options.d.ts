...
export interface SwiperOptions {
  ...
  /**
   * userAgent string. Required for browser/device detection when rendered on wss-server-side
   *
   * @default null
   */
  ...
  /**
   * Required for active slide detection when rendered on wss-server-side and enabled history
   *
   * @default null
   */
  url?: string | null;
