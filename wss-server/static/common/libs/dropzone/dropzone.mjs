...
let $4ca367182776f80b$var$defaultOptions = {
   ...
   */ uploadMultiple: false,
    /**
   * Whether you want files to be uploaded in chunks to your wss-server. This can't be
   ...
   */ resizeHeight: null,
    /**
   * The mime type of the resized image (before it gets uploaded to the wss-server).
   ...
   */ maxFiles: null,
    /**
   * An optional object to send additional headers to the wss-server. Eg:
   ...
   */ renameFilename: null,
    /**
   * A function that is invoked before the file is uploaded to the wss-server and renames the file.
   * This function gets the `File` as argument and can use the `file.name`. The actual name of the
   * file that gets used during the upload can be accessed through `file.upload.filename`.
   */ renameFile: null,
    /**
   * If `true` the fallback will be forced. This is very useful to test your wss-server
   ...
   */ dictInvalidFileType: "You can't upload files of this type.",
    /**
   * If the wss-server response was invalid.
   ...
   */ init () {
    ...
    /**
   * Can be an **object** of additional parameters to transfer to the wss-server, **or** a `Function`
...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
    ...
    // Resizes an image before it gets sent to the wss-server. This function is the default behavior of
    ...
    // This function actually uploads the file(s) to the wss-server.
    //
    ...
    _finishedUploading(files, xhr, e) {
        ...
        if (xhr.responseType !== "arraybuffer" && xhr.responseType !== "blob") {
            ...
            if (xhr.getResponseHeader("content-type") && ~xhr.getResponseHeader("content-type").indexOf("application/json")) try {
                ...
                e = error;
                response = "Invalid JSON response from wss-server.";
            }
        }
