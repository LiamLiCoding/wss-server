...
perPage = (checkAll && (checkAll.onclick = function() {
    for (var e = document.querySelectorAll('.form-check-all input[type="checkbox"]'), t = document.querySelectorAll('.form-check-all input[type="checkbox"]:checked').length, a = 0; a < e.length; a++) e[a].checked = this.checked,
...
tasksList = new List("tasksList", options).on("updated",
function(e) {
...
xhttp.onload = function() {
    ...
    Array.from(e).forEach(function(e) {
        ...
        3 < t.length && (t = t.length - 3, a += '<a href="javascript: void(0);" class="avatar-group-item"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="' + t + ' More">            <div class="avatar-xxs">            <div class="avatar-title rounded-circle">' + t + "+</div>            </div>        </a>"),
        a += "</div>",
        tasksList.add({
...
function tooltipElm() { [...document.querySelectorAll('[data-bs-toggle="tooltip"]')].map(e = >new bootstrap.Tooltip(e))
}
...
refreshCallbacks(),
document.getElementById("showModal").addEventListener("show.bs.modal",
function(e) {
...
document.querySelector("#tasksList").addEventListener("click",
function() {
    ischeckboxcheck()
});
        ...
        function(e) {
            ...
            Array.from(e).forEach(function(e) {
                ...
                a == itemId && (editlist = !0, idField.value = a, a = (project = (new DOMParser).parseFromString(e._values.project_name, "text/html")).body.firstElementChild.innerHTML, statusVal.setChoiceByValue(t), projectNameField.value = a, tasksTitleField.value = e._values.tasks_name, clientNameField.value = e._values.client_name, dateDueField.value = e._values.due_date, Array.from(document.querySelectorAll('input[name="assignedTo[]"]')).forEach(function(t) {
                    var a = t.parentElement.querySelector(".flex-grow-1").innerHTML; (new DOMParser).parseFromString(e._values.assignedto, "text/html").querySelectorAll(".avatar-group .avatar-group-item").forEach(function(e) {
...
function clearFields() {
    ...
    dateDueField.value = "",
    document.querySelectorAll('input[name="assignedTo[]"]').forEach(function(e) {
...
function assignToUsers() {
    ...
    3 < e.length && (e = e.length - 3, t += '<a href="javascript: void(0);" class="avatar-group-item"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="' + e + ' More">        <div class="avatar-xxs">        <div class="avatar-title rounded-circle">' + e + "+</div>        </div>    </a>"),
    t += "</div>"
}
