...
perPage = (checkAll && (checkAll.onclick = function() {
    for (var e = document.querySelectorAll('.form-check-all input[type="checkbox"]'), t = document.querySelectorAll('.form-check-all input[type="checkbox"]:checked').length, n = 0; n < e.length; n++) e[n].checked = this.checked,
    e[n].checked ? e[n].closest("tr").classList.add("table-active") : e[n].closest("tr").classList.remove("table-active");
...
apiKeyList = new List("apiKeyList", options).on("updated",
function(e) {
...
xhttp.onload = function() {
    ...
    Array.from(e).forEach(function(e) {
        ...
        "Active" == e.status ? document.querySelector(".disable-btn").innerHTML = "Disable": "Disable" == e.status && (document.querySelector(".disable-btn").innerHTML = "Enable"),
        refreshCallbacks()
    }),
...
function(e) {
    ...
    if (t.classList.remove("d-none"),
    0 == apiKeyNameField.value.length) return ! (t.innerHTML = "Please enter api key name");
    "" !== apiKeyNameField.value && "" !== apiKeyField.value && (apiKeyList.add({
